...
def coletar_dados():
    ...
    horas_uso = entrada_float("Quantas horas por dia voce planeja usar o ar-condicionado? ")
...
def calcular_custo(btu, horas_uso, tarifa=0.95, eer=11):
    pot_w = btu / eer
    kwh_mes = (pot_w / 1000) * horas_uso * 30
    custo = kwh_mes * tarifa
    return kwh_mes, custo
...
def gerar_pdf(dados, carga_total, carga_BTU, recomendacao, consumo_mensal, custo):
    ...
    print("Relatorio gerado com sucesso: relatorio_carga_termica.pdf")
